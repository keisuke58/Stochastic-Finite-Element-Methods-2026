...
\begin{figure}[ht]
    ...
    \caption{Left: GP epistemic uncertainty (posterior std) vs PCE truth on 1D slice at $N=66$. Right: epistemic band on propagated stress PDF. Epistemic contribution is $<5\%$ of aleatory at $N=66$.}
\end{figure}
