...
\begin{itemize}\small
  ...
  \item The difference is \textbf{stability}: NN error \textbf{grows} $25\times$ from 66 to 286 points (overfitting a smooth response), while PCE deg.~2 holds; deg.~3 is slightly \emph{worse} (over-parameterisation).
